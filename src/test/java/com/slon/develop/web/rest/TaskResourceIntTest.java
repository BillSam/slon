...
import com.slon.develop.domain.Task;
import com.slon.develop.repository.TaskRepository;
...
public class TaskResourceIntTest {
    ...
    private static final TaskFrequency DEFAULT_FREQUENCY = TaskFrequency.MONTHLY;
    private static final TaskFrequency UPDATED_FREQUENCY = TaskFrequency.YEARLY;
    ...
    public void createTask() throws Exception {
        ...
        assertThat(testTask.getFrequency()).isEqualTo(DEFAULT_FREQUENCY);
    }
    ...
    public void updateTask() throws Exception {
        ...
        assertThat(testTask.getFrequency()).isEqualTo(UPDATED_FREQUENCY);
    }
